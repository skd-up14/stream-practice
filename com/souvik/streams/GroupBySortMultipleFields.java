 ...
 *
 */
public class GroupBySortMultipleFields {

	/**
	 * Chaining of Comparator
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		List<Student> sortedList = studentList.stream().sorted(addressComparator.thenComparing(gradeComparator))
		...
		Map<String, Map<String, Long>> map = sortedList.stream().collect(Collectors.groupingBy(
				Student::getStudentAddress, Collectors.groupingBy(Student::getStudentGrade, Collectors.counting())));
